...
const WhatsAppFloat = () => {
    ...
    const message = encodeURIComponent("Hi TMR Industrial, I have an inquiry.");
    ...
    return (
        ...
        >
            ...
            <svg
                viewBox="0 0 24 24"
                className="w-10 h-10 relative z-10 fill-white"
            ...
            {/* Tooltip */}
            <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-white text-black px-4 py-2 rounded-lg text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl border border-gray-100">
